...
def initialize_arb():
    ...
    try:
        ...
        list_of_symbols2 = ['BTR_BTC', 'BTR_XRP', 'XRP_BTC']
       

        list_of_arb_sym = [list_of_symbols2]
...
def arbitrage_bin(list_of_sym, tickers, portfolio, cycle_num=10, cycle_time=30, place_order='No', real_order='No'):
    ...
    for i in range(0,1):    #initialize Exchange
        ...
        """
            ...
            arb_list = ['BTR/BTC'] #, 'BTR/XRP', 'BTC/XRP']
...
def tri_arb_paper(portfolio1, sym_list, list_exch_rates, fees='No', fee=0.0005):
    ...
    if sym_list[0][-3:]=='BTC':
        portf_pos = 0
    elif sym_list[0][-3:]=='BTR':
        portf_pos = 1
    elif sym_list[0][-3:]=='XRP':
        portf_pos = 2
    elif sym_list[0][-3:]=='USDT':
        portf_pos = 3
    if fees == 'Yes':
